...
function redirecionarParaOutroLugar() {
    // Use window.location.href para redirecionar a pessoa
    window.location.href = "https://api.whatsapp.com/send?phone=5579981269666&text=Eu%20aceito%20namorar%20com%20voc%C3%AA!"; // Substitua com o URL desejado
}
  
const buttonNo = document.querySelector('#btn-nao');
